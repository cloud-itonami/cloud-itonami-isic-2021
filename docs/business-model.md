# Business Model: Manufacture of pesticides and other agrochemical products
...
## Classification
- Repository: `cloud-itonami-isic-2021` ([github.com/cloud-itonami/cloud-itonami-isic-2021](https://github.com/cloud-itonami/cloud-itonami-isic-2021))
- ISIC Rev.5: `2021` — Manufacture of pesticides and other agrochemical products
- Domain: `:pesticide-agrochemical/manufacturing`
- Social impact: :worker-safety :consumer-safety :environmental-safety
- Actor: `:pesticide-agrochemical-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :pesticide-agrochemical/manufacturing — who wants
...
One managed tenant (:pesticide-agrochemical/manufacturing):
...
- Do not bypass the `:pesticide-agrochemical-plant-operations-governor` for production decisions.
