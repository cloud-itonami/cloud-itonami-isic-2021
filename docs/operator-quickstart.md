# Operator Quickstart — Manufacture of pesticides and other agrochemical products

Shortest path from clone to a verified local dry-run for **ISIC 2021** (`cloud-itonami-isic-2021`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2021.git
cd cloud-itonami-isic-2021
```
...
- Blueprint governor key: `pesticide-agrochemical-plant-operations-governor`
- Likely source path: `pesticidemfg.governor.cljc`
