(ns pesticidemfg.phase
  "Phase 0->3 staged rollout for the pesticide and other agrochemical
  product plant-operations coordination actor.
  ...
  consequence (a formulation/mixing or filling/packaging-line
  ...
  `pesticidemfg.governor`'s `line-actuate-blocked-violations` HARD-
  blocks actuate attempts unconditionally, and the confidence/high-
  stakes gate independently never lets `:flag-safety-concern`
...
(defn verdict->disposition
  "Map a Pesticide & Agrochemical Plant Operations Governor verdict to
  a base disposition before the phase gate."
  [verdict]
